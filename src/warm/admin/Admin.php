...
class Admin
{
    ...
    {
        return Auth::guard(self::warmConfig('app.auth.guard') ?: 'admin');
    }
     ...
     * 获取配置服务对象
     *
     * @return SystemConfigService 配置服务对象
     */
     ...
     * @return mixed 配置值
     */
    public static function warmConfig(string $key, mixed $default = ''): mixed
    {
    ...
    {
        return PluginService::make()->getPluginServiceByName($name);
    }
     ...
     */
    public static function view(string $apiPrefix = ''): array|string|null
    {
        if (!$apiPrefix) {
