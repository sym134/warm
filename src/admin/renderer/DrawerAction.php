...
$this->set('actionType', 'drawer');
    ...
    /**
     * 指定为打开弹窗，抽出式弹窗 可选值: prev | next | cancel | close | submit | confirm | add | reset | reset-and-submit
     */
    ...
    /**
     * 抽出式弹框详情 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/drawer (Drawer 抽出式弹框。 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/drawer)
     */
