...
class Menu
{
     ...
     * @return array 菜单结构数组
     */
    public function list2Menu(array $list, int $parentId = 0, string $parentName = ''): array
    {
        $data = [];
     ...
     * @return array 路由数组
     */
    public function generateRoute(array $item): array
    {
        $url = $item['path'] ?? '';
     ...
     */
    public function add(array $menus): static
    {
