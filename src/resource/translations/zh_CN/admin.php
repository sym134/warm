...
return [
    ...
    'code_generators' => [
        ...
        'dialog_form'                 => '弹窗表单',
        'copy_record'                 => '复制记录',
        'copy_record_description'     => '你可以复制后分享到 <a href="https://github.com/sym134/warm/discussions/categories/ideas" target="_blank">Github</a>',
        'import_record'               => '导入记录',
        'import_record_placeholder'   => '请输入导入的json记录',
        'import_record_desc'          => '你可以在 <a href="https://github.com/sym134/warm/discussions/categories/ideas" target="_blank">Github</a> 找到一些其他人分享的记录',
        'load_config'                 => '加载配置',
